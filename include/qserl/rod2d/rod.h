...
public:
  ...
  */
  ...
  integrateStateFromBaseWrench(const Wrench2D& i_wrench,
  ...
  */
  static bool
  isConfigurationSingular(const Wrench2D& i_cfgWrench);

  /**
  * \brief Returns corresponding stiffness coefficients a an extensible DLO from elasticity parameters.
  */
  static double
