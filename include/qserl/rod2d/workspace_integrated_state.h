...
public:
  ...
  typedef boost::array<double,
                       3> state_type;            /**< Type of 2D elastic rod states q(t) at position t, where q(t) is an element of the Lie Group SE(2). */
  typedef boost::array<double,
                       3> costate_type;          /**< Type of 2D elastic rod co-states mu(t) at position t, where mu(t) is an element of the dual Lie algebra se(2)*. */
