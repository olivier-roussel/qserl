...
*/
QSERL_EXPORT void computeMotionConstants(const Eigen::Vector3d& i_a, MotionConstants& o_motionConstants);
...
*/
QSERL_EXPORT void computeMuAtPositionT(double i_t, const MotionConstants& i_motionConstants, Eigen::Vector3d& o_mu);
