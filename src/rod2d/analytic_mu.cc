...
void computeMotionConstants(const Eigen::Vector3d& i_a, MotionConstants& o_motionConstants)
{
...
void computeMuAtPositionT(double i_t, const MotionConstants& i_motionConstants, Eigen::Vector3d& o_mu)
{
  static const double kEpsilonLambda = 1.e-12;
