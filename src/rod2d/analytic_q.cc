...
bool computeMotionConstantsQ(const Eigen::Vector3d& i_a, MotionConstantsQ& o_mc)
{
...
bool computeQAtPositionT(double i_t, const Eigen::Vector3d& i_a, const MotionConstantsQ& i_mc, 
  Eigen::Vector3d& o_qdot, Eigen::Vector3d& o_q)
{
  static const double kEpsilonLambda = 1.e-12;
  static const double kEpsilonNullTorque = 1.e-10;
  static const double kEpsilonNullForce = 1.e-10;
